        ...
        {mode === 'login' && (
          <div className="p-8">
             ...
             <div className="mt-6 text-center text-sm">
               ...
               <button onClick={() => { setMode('signup'); setErrorMsg(null); setShowResend(false); }} className="text-blue-400 hover:text-blue-300 font-bold">Sign Up</button>
             </div>
          </div>
        )}
        ...
        {mode === 'signup' && (
          <div className="p-6">
             <div className="flex items-center gap-2 mb-4">
                <button onClick={() => { setMode('welcome'); setErrorMsg(null); }} className="p-1 rounded-full hover:bg-slate-800 text-slate-400 hover:text-white transition-colors">
             ...
             <div className="mt-4 text-center text-sm">
               ...
               <button onClick={() => { setMode('login'); setErrorMsg(null); setShowResend(false); }} className="text-blue-400 hover:text-blue-300 font-bold">Log In</button>
             </div>
          </div>
        )}
